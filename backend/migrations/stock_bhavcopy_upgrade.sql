...
ALTER TABLE stock ADD COLUMN IF NOT EXISTS currency_code VARCHAR(3) NOT NULL DEFAULT 'INR';
ALTER TABLE stock ADD COLUMN IF NOT EXISTS country VARCHAR(50) NOT NULL DEFAULT 'India';
